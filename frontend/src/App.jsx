  ...
  return (
    <div className="app-container">
      ...
      <aside className="sidebar">
        ...
        {/* Navigation Tabs */}
        <nav style={{ display: 'flex', flexDirection: 'column', gap: '12px', overflowY: 'auto', flex: 1, paddingRight: '4px' }}>
          
          {/* Group 1: Core Command Console */}
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <button 
              ...
              style={{
                ...
                padding: '8px 10px', fontSize: '0.72rem', fontWeight: 700, textTransform: 'uppercase',
                letterSpacing: '0.05em', color: 'var(--text-dark)', background: 'none', border: 'none',
                cursor: 'pointer', textAlign: 'left'
              }}
            >
              <span>Core Command Console</span>
              <span style={{ fontSize: '0.65rem', transform: expandedGroups.core ? 'rotate(90deg)' : 'rotate(0deg)', transition: 'transform 0.15s' }}>▶</span>
            </button>
            {expandedGroups.core && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '5px', paddingLeft: '6px', marginTop: '4px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            >
              ...
              <span style={{ fontSize: '0.65rem', transform: expandedGroups.ai ? 'rotate(90deg)' : 'rotate(0deg)', transition: 'transform 0.15s' }}>▶</span>
            </button>
            {expandedGroups.ai && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '5px', paddingLeft: '6px', marginTop: '4px' }}>
          ...
          {/* Group 3: Outreach & Campaigns */}
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <button 
              type="button"
              onClick={() => toggleGroup('outreach')} 
              style={{
                display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%',
                padding: '8px 10px', fontSize: '0.72rem', fontWeight: 700, textTransform: 'uppercase',
                letterSpacing: '0.05em', color: 'var(--text-dark)', background: 'none', border: 'none',
            ...
            >
              ...
              <span style={{ fontSize: '0.65rem', transform: expandedGroups.outreach ? 'rotate(90deg)' : 'rotate(0deg)', transition: 'transform 0.15s' }}>▶</span>
            </button>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            >
              ...
              <span style={{ fontSize: '0.65rem', transform: expandedGroups.network ? 'rotate(90deg)' : 'rotate(0deg)', transition: 'transform 0.15s' }}>▶</span>
            </button>
            {expandedGroups.network && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '5px', paddingLeft: '6px', marginTop: '4px' }}>
                ...
                <button className={`sidebar-nav-btn ${activeTab === 'sessionRotator' ? 'active-nav' : ''}`} onClick={() => setActiveTab('sessionRotator')}>
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M4 4v5h.582m15.356 2A8.001 8.001 0 1121.21 7.89M9 11l3-3m0 0l-3-3m3 3H9" /></svg> Multi-Session Rotator
                </button>
          ...
          {/* Group 5: Storefront & Escrow Hub */}
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <button 
              type="button"
              onClick={() => toggleGroup('storefront')} 
              style={{
                display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%',
                padding: '8px 10px', fontSize: '0.72rem', fontWeight: 700, textTransform: 'uppercase',
                letterSpacing: '0.05em', color: 'var(--text-dark)', background: 'none', border: 'none',
            ...
            >
              ...
              <span style={{ fontSize: '0.65rem', transform: expandedGroups.storefront ? 'rotate(90deg)' : 'rotate(0deg)', transition: 'transform 0.15s' }}>▶</span>
            </button>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            >
              ...
              <span style={{ fontSize: '0.65rem', transform: expandedGroups.security ? 'rotate(90deg)' : 'rotate(0deg)', transition: 'transform 0.15s' }}>▶</span>
            </button>
          ...
          {/* Group 7: Diagnostic Sandbox */}
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <button 
              type="button"
              onClick={() => toggleGroup('diagnostic')} 
              style={{
                display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%',
                padding: '8px 10px', fontSize: '0.72rem', fontWeight: 700, textTransform: 'uppercase',
                letterSpacing: '0.05em', color: 'var(--text-dark)', background: 'none', border: 'none',
            ...
            >
              ...
              <span style={{ fontSize: '0.65rem', transform: expandedGroups.diagnostic ? 'rotate(90deg)' : 'rotate(0deg)', transition: 'transform 0.15s' }}>▶</span>
            </button>
